...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, x1000_Pin|x100_Pin|x10_Pin|x1_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pin : LED_VCC_Pin */
  ...
  /*Configure GPIO pins : x1000_Pin x100_Pin x10_Pin x1_Pin */
  GPIO_InitStruct.Pin = x1000_Pin|x100_Pin|x10_Pin|x1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
